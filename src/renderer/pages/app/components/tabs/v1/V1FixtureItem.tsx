...
import V1TeamLogo from './V1TeamLogo';
import { useAppDispatch } from '@app/store/store';
import { createV1DataController } from '@app/v1/services/v1DataController';

interface V1FixtureItemProps {
  fixture: FixtureByLeagueResponse;
}

const V1FixtureItem = ({ fixture }: V1FixtureItemProps) => {
    ...
    <Container>
      ...
      <VersusBox>
        <TeamBox>
          ...
          <V1TeamLogo logo={homeTeam.logo} name={homeTeam.name} />
        </TeamBox>
        ...
        <TeamBox>
          <V1TeamLogo logo={awayTeam.logo} name={awayTeam.name} />
